...
import fr.cnes.regards.modules.dam.domain.models.schema.Property;
import fr.cnes.regards.modules.dam.domain.models.schema.Restriction;
import fr.cnes.regards.modules.dam.domain.models.schema.Type;
...
public class AttributeModel implements IIdentifiable<Long>, IXmlisable<Attribute> {
    ...
    public Attribute toXml() {
        ...
        xmlType.setValue(fr.cnes.regards.modules.dam.domain.models.schema.RestrictionType.fromValue(type.toString()));
